    ...
    var Slider=function(id,config){
        ...
        return {
            ...
            _setup:function(){
                ...
                var ul= t.$el.querySelectorAll(".full-page");
                t.$dom=ul[0];
                ...
                t.$li=[].slice.call( t.$dom.querySelectorAll('li.item') ,0 );
                ...
                t.$li[_private.index].classList.add("swiper-slide-active");
                ...
                (function(last_index){
                    setTimeout(function(){
                        t.config.onLeave.call(t.$li[last_index],last_index ,t.len);
                         // t.$li[last_index].classList.add("slider-leave");
                         t.$li[last_index].classList.remove("swiper-slide-active");
                    },t.config.duration*1000);
                })(_private.index);
            },
            get_prev_next:function(index){
                return {
                    prev:index-0
                }
            },
            ...
            move_decrease:function(step){
                ...
                if(_private.index<=-1){
                 ...
                 t.config.onEnter.call(t.$li[ _private.index ], _private.index ,t.len);
                 var classlist=t.$li[_private.index].classList;
